export function carrito() {
    ...
    function Bolivares () {
        const bolivares = productosCarrito.reduce((acumulador,producto) => {
            const precioBolivares = Number(producto.precio.replace('$', ''));
            return acumulador + ((precioBolivares * producto.cantidad) * 64.25)
        },0)
        totalBolivares.textContent = 'Total Bs' + ' ' + bolivares;
        return bolivares;
    }
